...
//     return (
//         <>
//             <section className="flex justify-evenly items-center py-20 font-afacad">
//                 <div>
//                     <h1 className="text-6xl text-aqua font-briem-hand 
//                     mb-4">
//                         TechCodeLab</h1>
//                     <h2 className="text-2xl text-blue-2 font-bold">Cursos de programación para pasar de 0 a experto.</h2>
//                     <p className="text-xl text-blue-2 max-w-[500px]">
//                       Desde lo más básico hasta conceptos avanzados, cada lección 
//                       está diseñada para que puedas construir tu conocimiento paso a paso, 
//                       enfrentando retos y creando soluciones reales.
//                       No importa tu nivel inicial, lo único que necesitas es la motivación 
//                       para empezar.
//                     </p>
//                     <button className="bg-blue-3 text-white my-4 button-custom">Empieza ya</button>
//                 </div>
...
//             border-t-10 border-blue-3
//             bg-gradient-to-b from-aqua/50 to-blue-1/50">
//                 <div>
//                 <h2 className="text-6xl text-blue-3 font-briem-hand">
...
//                     <img 
//                         className="w-[150px] h-[150px] rounded-[48px]"
//                         loading="lazy"
//                         src={javascript}/>
//                     <img 
//                         className="w-[150px] h-[150px] rounded-[48px]"
